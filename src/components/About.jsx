    ...
    return (
        <div className="aboutpage">
            <div className="person">
                <img className="personimage" src={sauliholappa} alt="Sauli Holappa" title="Sauli Holappa" />
            ...
            <div className="persontwo">
                ...
                <img className="personimage" src={markkuvaara} alt="Markku Vaara" title="Markku Vaara" />
            </div>
        </div>
    )
}
